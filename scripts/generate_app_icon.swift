...
let symbolName = arguments.count >= 3 ? arguments[2] : "camera.viewfinder"
...
func drawIcon(size pixels: CGFloat) throws -> NSImage {
  guard let baseSymbol = NSImage(systemSymbolName: symbolName, accessibilityDescription: nil) else {
    throw NSError(domain: "OkBrainMacOSAgentIcon", code: 1, userInfo: [
  ...
  NSColor(red: 0.08, green: 0.11, blue: 0.13, alpha: 1).setFill()
  NSBezierPath(roundedRect: rect, xRadius: pixels * 0.20, yRadius: pixels * 0.20).fill()
...
func writePNG(_ image: NSImage, to url: URL) throws {
  guard
    ...
    throw NSError(domain: "OkBrainMacOSAgentIcon", code: 2, userInfo: [
...
if process.terminationStatus != 0 {
  throw NSError(domain: "OkBrainMacOSAgentIcon", code: Int(process.terminationStatus), userInfo: [
