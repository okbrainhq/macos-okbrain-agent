...
The curated function catalog also includes permission-gated `menubar.list`, `menubar.open`, and `menubar.click` functions for status-item popup menus. They require macOS Accessibility permission; discover their schemas through `functions.list`.
